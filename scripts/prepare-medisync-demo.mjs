...
const destination = resolve(root, 'public/demos/medisync')
const basePath = '/demos/medisync/'
const sourceCandidates = [
  resolve(root, '../medisync'),
  resolve(root, '../../../medisync'),
  resolve(root, '../medisync/.worktrees/medisync-demo'),
  resolve(root, '../../../medisync/.worktrees/medisync-demo'),
]
...
if (!sourceRoot) {
  throw new Error(`Medisync project was not found at ${sourceCandidates.join(' or ')}`)
}
